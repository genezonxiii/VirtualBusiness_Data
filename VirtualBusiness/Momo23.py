...
class Momo23_Data():
    ...
    def Momo_23_Data(self, supplier, GroupID, path, UserID):

        try:

            logger.debug("===Momo23_Data===")
            ...
            logger.debug('===Momo23_Data finally===')
...
if __name__ == '__main__':
    ...
    print momo.Momo_23_Data('momo',groupid,u'C:\\Users\\10509002\\Documents\\電商檔案\\網購平台訂單資訊\\momo\\2015\\2015.11.04\\A1102_3_2_008992_20151104105639.xls','system')
