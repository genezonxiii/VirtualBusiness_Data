...
class Momo25_Data():
    ...
    def parserData(self,table,row_index,GroupID,UserID,supplier):
        try:
            ...
            self.sale.setC_Product_id(str(table.cell(row_index, self.TitleList.index(self.TitleTuple[8])).value).split('.')[0])
...
if __name__ == '__main__':
    ...
    print momo.Momo_25_Data('momo',groupid,u'C:\\Users\\10509002\\Desktop\\新增資料夾 (2)\\0407\\momo摩天商城\\1458525585016.xls','system')
