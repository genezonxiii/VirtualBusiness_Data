...
class Nine_Data():
    ...
    def Nine_Data(self,supplier,GroupID,path,UserID):
        ...
        logging.info('===Nine_Data SUCCESS===')
        return 'success'
