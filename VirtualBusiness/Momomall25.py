...
class Momomall25_Data():
    ...
    TitleTuple = (u'訂單編號', u'付款日', u'最晚出貨日', u'收件人姓名', u'電話',
                  u'行動電話', u'地址', u'商品編號',u'商品名稱', u'數量', u'成交價')
    TitleList = []
    ...
    def Momomall_25_Data(self, supplier, GroupID, path, UserID):

        try:

            logger.debug("===Momomall25_Data===")
            ...
            logger.debug('===Momall25_Data finally===')
    ...
    def parserData(self,table,row_index,GroupID,UserID,supplier):
        try:
            ...
            self.sale.setProduct_name(table.cell(row_index, self.TitleList.index(self.TitleTuple[8])).value)
...
if __name__ == '__main__':
    momomall = Momomall25_Data()
    # groupid = ""
    groupid='cbcc3138-5603-11e6-a532-000d3a800878'
    print momomall.Momomall_25_Data('momomall',groupid,u'C:\\Users\\10509002\\Documents\\電商檔案\\網購平台訂單資訊\\摩天商城\\2015.11.02\\C102_101790_20151102135457.xls','system')
