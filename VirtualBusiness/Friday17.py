...
class Friday17_Data():
    ...
    def Friday_17_Data(self, supplier, GroupID, path, UserID):

        try:

            logger.debug("===Friday17_Data===")
            ...
            logger.debug('===Friday17_Data finally===')
    ...
    def parserData(self,table,row_index,GroupID,UserID,supplier):
        try:
            ...
            self.sale.setProduct_name((table.cell(row_index, self.TitleList.index(self.TitleTuple[7])).value).split('\n')[1])
...
if __name__ == '__main__':
    friday = Friday17_Data()
    # groupid = ""
    groupid='cbcc3138-5603-11e6-a532-000d3a800878'
    print friday.Friday_17_Data('friday',groupid,u'C:\\Users\\10509002\\Documents\\電商檔案\\網購平台訂單資訊\\Firday\\2015.09.07\\訂單處理_20150907.xls','system')
