...
class Umall31_Data():
    ...
    def Umall_31_Data(self, supplier, GroupID, path, UserID):
        ...
        try:
            ...
            logger.info('===Umall31_Data SUCCESS===')
            return 'success'
    ...
    def parserData(self,table,row_index,GroupID,UserID,supplier):
        try:
            ...
            self.customer.setPhone(row[17].lstrip("'"))
...
if __name__ == '__main__':
    ...
    print umall.Umall_31_Data('umall',groupid, u'C:\\Users\\10509002\\Documents\\電商檔案\\網購平台訂單資訊\\東森\\2014\\2014.10.23\\zip-temp\\cso_export_1414030494004.csv','system')
