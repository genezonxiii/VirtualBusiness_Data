...
class UDN_Data3():
    ...
    def UDN_Data3(self,supplier,GroupID,path,UserID):
        ...
        for row_index in range(2,table.nrows):
            for col_index in range(0,num_cols):
                ...
                TurnDate = datetime.datetime.strptime(str(table.cell_value(row_index, 4)),'%Y/%m/%d')
                ...
                Phone = str(table.cell(row_index, 8).value)
                ClientPhone = aes.AESencrypt("p@ssw0rd", Phone, True)
                Tel = str(table.cell(row_index, 7).value)
                ...
                PartTotalPrice = table.cell(row_index, 21).value
        ...
        logging.info('===UDN_Data3 SUCCESS===')
        return 'success'
    ...
    def insertClient(self,mongodbClient,_OrderNo,_ClientName,_ClientTel,\
        ...
        businessorder_doc={'OrderNo':_OrderNo,'ClientName':[_ClientName],'ClientTel':[_ClientTel],'ClientPhone':[_ClientPhone],\
                           'firm':[_firm],'supplier':[_supplier]}
