...
class Momo28_Data():
    ...
    def Momo_28_Data(self, supplier, GroupID, path, UserID):

        try:

            logger.debug("===Momo28_Data===")
            ...
            logger.debug('===Momo28_Data finally===')
...
if __name__ == '__main__':
    ...
    print momo.Momo_28_Data('momo',groupid,u'C:\\Users\\10509002\\Documents\\電商檔案\\2016\\0825- MOMO轉單(廠送)-Vivian\\A1102_1_003873_20160824090439.xls','system')
