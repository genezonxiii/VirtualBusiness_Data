...
class PCHome3_Data():
    ...
    def PCHome3_Data(self,supplier,GroupID,path,UserID):
        ...
        for row_index in range(6, table.nrows):
            ...
            ProductSQL = (
            str(uuid.uuid4()), GroupID, PartNo, PartName, supplier,None,None, 0, PartTotalPrice, 0,None, None,
            None, None)
            CustomereSQL = (
            str(uuid.uuid4()), GroupID, ClientName,None, None, ClientPhone,None,None,None,None)
            ...
            if result != []:
                ...
                if Name.encode('utf-8') in Name_compare:
                    ...
                    mysqlconnect.cursor.execute(CustomereSQLupd, (
                        None,None, ClientPhone,None,None,None,None, GroupID, x[1]))
                else:
                    print "select insert"
            ...
            for y in customer_id_temp:
                for x in result:
                    if aes.AESdecrypt('p@ssw0rd', x[1], True) == Name.encode('utf-8'):
                        ...
                        # str(uuid.uuid4()), OrderNo, GroupID, '132345', y[0], x[1], PartNo, PartQuility, PartTotalPrice,
                        # TurnDate,PartName))
        ...
        logging.info('===PCHome3_Data SUCCESS===')
        return 'success'
