...
class Savesafe23_Data():
    ...
    def Savesafe_23_Data(self, supplier, GroupID, path, UserID):
        ...
        try:
            ...
            logger.info('===Savesafe23_Data SUCCESS===')
            return 'success'
...
if __name__ == '__main__':
    savesafe = Savesafe23_Data()
    # groupid = ""
    groupid='cbcc3138-5603-11e6-a532-000d3a800878'
    print savesafe.Savesafe_23_Data('Savesafe',groupid, u'C:\\Users\\10509002\\Documents\\電商檔案\\網購平台訂單資訊\\大買家\\2015.09.30\\20159301218543266.xls','system')
