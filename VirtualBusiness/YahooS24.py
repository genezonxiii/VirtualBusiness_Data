...
class YahooS24_Data():
    ...
    TitleTuple = (u'訂單編號', u'轉單日', u'最晚出貨日', u'收件人姓名', u'商品編號',
                  u'收件人電話', u'收件人行動電話', u'金額小計',u'收件人地址', u'店家商品料號',
                  u'商品名稱', u'數量')
    TitleList = []
    ...
    def parserData(self,table,row_index,GroupID,UserID,supplier):
        try:
            ...
            self.sale.setPrice(table.cell(row_index, self.TitleList.index(self.TitleTuple[7])).value)
...
if __name__ == '__main__':
    ...
    print yahoo.YahooS_24_Data('yahoo',groupid,u'C:\\Users\\10509002\\Desktop\\新增資料夾 (2)\\0407\\yahoo 超級商城\\storders.xlsx','system')
