...
class Umall32_Data():
    ...
    def Umall_32_Data(self, supplier, GroupID, path, UserID):
...
if __name__ == '__main__':
    ...
    print umall.Umall_32_Data('umall',groupid, u'C:\\Users\\10509002\\Documents\\電商檔案\\網購平台訂單資訊\\東森\\2015.02.16\\zip-temp\\cso_export_1424054778089.csv','system')
