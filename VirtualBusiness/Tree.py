...
class TREE_Data():
    ...
    def TREE_Data(self,supplier,GroupID,path,UserID):
        ...
        for row_index in range(1,table.nrows):
            for col_index in range(0,num_cols):
                ...
                PartName = table.cell(row_index, 5).value
                PartNo = str(table.cell(row_index, 4).value)
            ...
            ProductSQL = (str(uuid.uuid4()), GroupID, PartNo, PartName,supplier,None,None,PartCost,0,0,None,None,None,None)
                ...
                for x in result:
                    if aes.AESdecrypt('p@ssw0rd', x[1], True) == Name.encode('utf-8'):
                        SaleSQL = (
                            ...
                            x[1], PartQuility, PartCost, None, TurnDate, TurnDate, TurnDate,
                        ...
                        # mysqlconnect.cursor.execute(SalestrSQL,(str(uuid.uuid4()), OrderNo, GroupID, '12345', y[0], x[1], PartNo, PartQuility,PartCost, TurnDate,PartName))
    ...
    def updataOrder(self,mongoOrder,_OrderNo,_PartName,_PartNo,\
        ...
        mongoOrder.cursor.update({ "OrderNo" : _OrderNo,'firm':_firm,'supplier':_supplier},\
                           ...
                           'PartQuility':_PartQuility,'Price':_PartCost,'TurnDate':_TurnDate}}
                                                )
