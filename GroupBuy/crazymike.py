...
if __name__ == '__main__':
    buy = Crazymike()
    print buy.parserFile('cbcc3138-5603-11e6-a532-000d3a800878', 'test', 'healthmike', 2 , 'MS',
                  inputFile=u'C:/Users/10509002/Desktop/orders-1048-ex_2 (2).csv', \
